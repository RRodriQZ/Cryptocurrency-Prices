from functions.payloads import criptoFacil_url, criptoFacil_payloads, \
    copter_url, copter_payloads, ripio_url, ripio_payloads
from functions.functions import get_all_values_from_payload, get_crypto_prices
from model.cryptoCurrency_model import CryptoCurrency
from functions.payloads import CRYPTO_LIST
import unittest
...
class CryptoTest(unittest.TestCase):
    ...
    def testCryptoFacilValues(self):
        ...
        cryptoFacil = get_crypto_prices(url, param)
    ...
    def testCopterValues(self):
        ...
        copter = get_crypto_prices(url, param)
    ...
    def testRipioValues(self):
        ...
        ripio = get_crypto_prices(url, param)
    ...
    def testQuantityCryptoPayloadIsEigth(self):
        crypto_value_list = get_all_values_from_payload(self.CRYPTO_LIST)
